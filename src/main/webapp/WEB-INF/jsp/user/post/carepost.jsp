...
<div class="super_container">
    ...
    <div class="recent">
        <c:if test="${not empty postBasicInformations}">
            <div class="container">
                <div class="row">
                    <div class="col">
        ...
        <c:if test="${ empty postBasicInformations}">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="section_title" style="color: darkred; font-size: 15px">Bạn chưa thêm bài đăng nào vào quan tâm!</div>
                    </div>
                </div>
            </div>
        </c:if>
