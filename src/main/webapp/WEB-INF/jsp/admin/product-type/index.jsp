                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                <table id="table"  border="1px">
                                    ...
                                    <c:forEach var="objProduct" items="${listProductTypes}">
                                            <c:set var="urlDelete" value="${pageContext.request.contextPath}/admincp/category/delete/${objProduct.id}"></c:set>
                                            <c:set var="urlEdit" value="${pageContext.request.contextPath}/admincp/category/${objProduct.id}"></c:set>
                                    <tr>
                                        <td style="width:5%">${objProduct.id}</td>
                                        <td>${objProduct.name}</td>
                                        <td>
                                            <button type="button" class="btn btn-custon-four btn-warning"><a style="padding: 5px;" href="${urlEdit}" class="on-default edit-row"><i class="fa fa-pencil"></i></a></button>
                                            <button type="button" class="btn btn-custon-four btn-danger">InActive</button>
                                            <button type="button" class="btn btn-custon-four btn-success">Active</button>
